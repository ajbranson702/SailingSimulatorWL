...
Status: started. Initial start-sequence, early-start detection, AI pre-start strategy behavior, and upwind port/starboard collision penalties are implemented.
