...
def test_mark_sequences_match_supported_course_formats():
    assert mark_sequence_for(RaceFormat.W2) == [MarkType.WINDWARD, MarkType.LEEWARD]
    assert mark_sequence_for(RaceFormat.T3) == [MarkType.WINDWARD, MarkType.GYBE, MarkType.LEEWARD]
    assert mark_sequence_for(RaceFormat.W4) == [
        MarkType.WINDWARD,
        MarkType.LEEWARD,
        MarkType.WINDWARD,
        MarkType.LEEWARD,
